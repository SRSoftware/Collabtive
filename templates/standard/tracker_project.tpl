...
<div class="timetrack">
	...
	<div class="timetrack">
		<div class="headline">
            ...
            <a class="open3a" href="managetimetracker.php?action=open3Atime&amp;id={$project.ID}{if $start != "" and $end != ""}&amp;start={$start}&amp;end={$end}{/if}{if $usr > 0}&amp;usr={$usr}{/if}{if $task > 0}&amp;task={$task}{/if}{if $fproject|default > 0}&amp;project={$fproject|default}{/if}"><span>{#open3aexport#}</span></a>
					</div>
				</div>
